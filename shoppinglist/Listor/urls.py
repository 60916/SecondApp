...
urlpatterns = [
    ...
    path('lista/<int:pk>/uppdatera', views.UppdateraVara.as_view(), name='vara-uppdatera'),
    path('lista/<int:pk>/radera', views.RaderaVara.as_view(), name='vara-radera'),
    ...
    path('loggaut/',auth_views.LogoutView.as_view(), name='listor/loggaut.html', name='loggaut'),
